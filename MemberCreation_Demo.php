            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form method="POST" action="MemberCreation_Review_test.php"  enctype="multipart/form-data" >
                        <div class="card-body">
                          ...
                          <input type="hidden" value="<?php echo $HOtelNameChk ;?>" id="hotlName" name="hotlName" required>
                             ...
                             <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_LeadSource" name="Static_LeadSource" value="<?php if($Mainid!=""){echo $fetchLead_Sources['Name'];} ?>"  required readonly>
                                </div>
                            </div>
                         ...
                         <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_FirstName" name="Static_FirstName"  value="<?php if($Mainid!=""){echo $fetchLead['FirstName'];} ?>" placeholder="First Name *" required readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Last Name</label>
                                    <input type="text" class="form-control" id="Static_LastName" name="Static_LastName" value="<?php if($Mainid!=""){echo $fetchLead['LastName'];} ?>" placeholder="Last Name *" required readonly>
                                </div>
                            </div>
                         ...
                         <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_AssignedTo" name="Static_AssignedTo"  value="<?php if($Mainid!=""){echo $fetchSalesmanId['FirstName']." ".$fetchSalesmanId['LastName'];} ?>" required  readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Date of Assignment</label>
                                    <input type="text" class="form-control" id="Static_DateOfAssignment" name="Static_DateOfAssignment" value="<?php if($Mainid!=""){echo $fetchDelegate['DelegatedTIme'];} ?>" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_DateOfEntry" name="Static_DateOfEntry"  value="<?php if($Mainid!=""){echo $fetchLead['Creation'];} ?>"  required readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Status</label>
                                    <input type="text" class="form-control" id="Static_Status" name="Static_Status" value="<?php if($Mainid!=""){   if($fetchLead['Status']=='4'){echo "Payment Received " ;} } ?>"  required readonly>
                                </div>
                            </div>
                     <!-- <div class="form-group col-md-6">
                                    <label for="inputPassword4">Reference from</label>
                                    <input type="text" class="form-control" id="LastName" name="LastName" value="<?php if($Mainid!=""){echo $fetchLead['LastName'];} ?>"   readonly>
                                </div>-->
                           ...
                           <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">First Name</label>
                                    <input type="text" class="form-control" id="Primary_FirstName" name="Primary_FirstName"  value="<?php if($Mainid!=""){echo $fetchLead['FirstName'];} ?>" placeholder="First Name *" required readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Last Name</label>
                                    <input type="text" class="form-control" id="Primary_LastName" name="Primary_LastName" value="<?php if($Mainid!=""){echo $fetchLead['LastName'];} ?>" placeholder="Last Name *" required  readonly>
                                </div>
                            </div>
                              ...
                              <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Company" name="Primary_Company" value="<?php if($Mainid!=""){echo $fetchLead['Company'];} ?>" placeholder="Company Name " required readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Designation</label>
                                    <input type="text" class="form-control" id="Primary_Designation" name="Primary_Designation" value="<?php if($Mainid!=""){echo $fetchLead['Designation'];} ?>" placeholder="Designation " required  readonly>
                                </div>
                            </div>
                             ...
                             <div class="form-group col-md-6">
                                <label for="inputAddress2">State</label>
                                     <input type="text" class="form-control" id="Primary_State" name="Primary_State" placeholder="State *"  value="<?php if($Mainid!=""){echo $fetchState['state'];} ?>" required readonly>
                        
                            </div>
                            
                              <div class="form-group col-md-6">
                                <label for="inputAddress2">City</label>
                              <input type="text" class="form-control" id="Primary_City" name="Primary_City" placeholder="city *"  value="<?php if($Mainid!=""){echo $fetchLead['City'];} ?>" required readonly>
                       ...
                       <div class="form-row">
                               ...
                               <select class="form-control"  name="Primary_Country" id="Primary_Country" required  readonly>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Pincode" name="Primary_Pincode" value="<?php if($Mainid!=""){echo $fetchLead['PinCode'];} ?>"  placeholder="Pincode *" required readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" id="Primary_Gmail_1" name="Primary_Gmail_1" placeholder="Email *"  value="<?php if($Mainid!=""){echo $fetchLead['EmailId'];} ?>" readonly required>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control"  name="Primary_mcode1" id="Primary_mcode1" maxlength="3"   value="+<?php if($Mainid!=""){echo $fetchLead['MobileCode'];} ?>"  placeholder="eg. 91" required readonly>
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Mobile number *</label>&nbsp;<label id="label5"></label>
                                    <input type="text" class="form-control" id="Primary_mob1" name="Primary_mob1" maxlength="10" value="<?php if($Mainid!=""){echo $fetchLead['MobileNumber'];} ?>"  placeholder="Mobile number" required  readonly>
                                </div>
                            </div>
