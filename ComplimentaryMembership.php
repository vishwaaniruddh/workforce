            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> Complimentary Membership Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                 Complimentary Membership Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="ComplimentaryMembership_Process.php"  onsubmit="return validation()" >
                        <div class="card-body ">
                            <div class="form-group">
                                ...
                                <label for="inputAddress">Program Level</label>&nbsp;
                                       ...
                                       <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="MembershipFee" name="MembershipFee" value="0" placeholder="Membership Fee*" required>
                                        </div>
