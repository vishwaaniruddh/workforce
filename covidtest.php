...
$EmailSubject2="Namaskar from Vishal Kamat!";
 ...
 $qrys1=mysqli_query($con2,"select Static_LeadID,Primary_nameOnTheCard from MembersTest where  MembershipDetails_Level IN (2,3)");
 
 //echo "select Static_LeadID,Primary_nameOnTheCard from MembersTest where status=0 and MembershipDetails_Level IN (2,3) <br>";
...
while($fetchMem=mysqli_fetch_array($qrys1)){ 
    ...
    //var_dump($fetchMem);exit;
    $to = '';

    
    $qrys2=mysqli_query($con2,"select EmailId from Leads_tableTest where  Lead_id='".$fetchMem['Static_LeadID']."' ");
    
    //echo "select EmailId from Leads_tableTest where  Lead_id='".$fetchMem['Static_LeadID']."' ". $to.'<br>';
