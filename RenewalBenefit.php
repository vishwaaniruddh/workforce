...
<script>
    function validation()
    {
     ...
     var RenewalBenefits= document.getElementById("RenewalBenefits").value;
     if(Program=="")
     {
     ...
     else if(RenewalBenefits=="")
     {
     swal("Please enter Renewal Benefits ");
     return false;
     } 
     else
     {
            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> Renewal  Benefits Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                Renewal  Benefits Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="RenewalBenefit_Process.php"  onsubmit="return validation()" >
                        <div class="card-body ">
                            <div class="form-group">
                                ...
                                <label for="inputAddress">Program Level</label>&nbsp;
                                     ...
                                     <div class="form-group">
                                        <label for="inputAddress">Renewal  Benefits</label>&nbsp;<label id="label3"></label>
                                      ...
                                      <table class="form-table" id="customFields">
                                        ...
                                        <div class="form-group col-md-10">
                                      	<input type="text" class="code form-control" id="RenewalBenefits" name="RenewalBenefits[]" value="" placeholder="Renewal  Benefits *" required/> &nbsp;
                                        </div>
...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td style="display:flex;    width: 179%;"><input type="text" class="code form-control" id="RenewalBenefits" name="RenewalBenefits[]" value="" placeholder="Renewal Benefits *" required/>  &nbsp;<button type="button" class="btn m-b-15 ml-2 mr-2  btn-rounded-circle btn-info remCF"><i class="mdi mdi-minus"></i></button> </td></tr>');
	});
