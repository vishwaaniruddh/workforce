                    ...
                    <div class="card m-b-30">
                      ...
                      <form id="memberForm" method="POST" enctype="multipart/form-data" >
                        <div class="card-body">
                              ...
                              <div class="bg-dark" style="color:white; padding: 10px; margin-bottom: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Static Info</div>
                     ...
                     <!-- <div class="form-group col-md-6">
                              ...
                              <div class="bg-dark" style="color:white; padding: 10px; margin-bottom: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 1. Primary Member Entry</div>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group ">
                             ...
                             <div class="form-group ">
                              ...
                              <div class="bg-dark" style="color:white; padding: 10px; margin-bottom: 15px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Part 3 Membership Details</div>
                        <?php 
