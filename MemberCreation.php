           ...
           $("#Spouse_LastName").attr("required",true);
            $("#Spouse_GmailMArrid1").attr("required",true);
             $("#Spouse_mcode1Married1").attr("required",true);
              ...
              $("#Spouse_DateOfBirth").attr("required",true);
    ...
    if(value=='Married'){
            ...
            $("#Spouse_GmailMArrid1").attr("required",false);
             $("#Spouse_mcode1Married1").attr("required",false);
              $("#Spouse_mob1MArid1").attr("required",false);
               $("#Spouse_DateOfBirth").attr("required",false);
      ...
      document.getElementById('Spouse_Contact1Married').value=""; 
       document.getElementById('Spouse_Contact2Married').value=""; 
        document.getElementById('Spouse_DateOfBirth').value=""; 
...
function val(){
     ...
     var MemshipDts_GST_number= document.getElementById("MemshipDts_GST_number").value;

if(MemshipDts_GST_number!="" && MemshipDts_GST_number.length<"15"){
    alert("GST number should not be less than 15 digits.");
    return false;
}else if(MemshipDts_GST_number!="" && MemshipDts_GST_number.length>"15"){
    alert("GST number should not be more than 15 digits.");
    return false;
}
  else if(MemshipDts_GST_number!="" && MemshipDts_GST_number.length=="15"){
    return true;
    ...
    function validation(){
     ...
     var marr=document.getElementById('Primary_MaritalStatus').value;
     var ann=document.getElementById('Primary_Anniversary').value;
  ...
  //   Spouse_mob1MArid1 Spouse_mcode1Married2 Spouse_mob1MArid2  Spouse_Contact1Married Spouse_Contact2Married Spouse_nameOnTheCardMarried
    ...
    else if(marr=="Married" && ann=="")
    {
        swal("Please Enter Anniversary Date")
		return false;
    }
     else{
                        ...
                        <div class="card-body">
                          ...
                          <input type="hidden" value="<?php echo $HOtelNameChk ;?>" id="hotlName" name="hotlName" required>
                             ...
                             <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_LeadID" name="Static_LeadID"  value="<?php if($Mainid!=""){echo $fetchLead['Lead_id'];} ?>"  required>
                                </div>
                                <div class="form-group col-md-6">
                         ...
                         <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_FirstName" name="Static_FirstName"  value="<?php if($Mainid!=""){echo $fetchLead['FirstName'];} ?>" placeholder="First Name *" required >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Last Name</label>
                                    <input type="text" class="form-control" id="Static_LastName" name="Static_LastName" value="<?php if($Mainid!=""){echo $fetchLead['LastName'];} ?>" placeholder="Last Name *" required >
                                </div>
                            </div>
                         ...
                         <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_AssignedTo" name="Static_AssignedTo"  value="<?php if($Mainid!=""){echo $fetchSalesmanId['FirstName']." ".$fetchSalesmanId['LastName'];} ?>" required  >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Date of Assignment</label>
                                    <input type="text" class="form-control" id="Static_DateOfAssignment" name="Static_DateOfAssignment" value="<?php if($Mainid!=""){echo $fetchDelegate['DelegatedTIme'];} ?>" required >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Static_DateOfEntry" name="Static_DateOfEntry"  value="<?php if($Mainid!=""){echo $fetchLead['Creation'];} ?>"  required >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Status</label>
                                    <input type="text" class="form-control" id="Static_Status" name="Static_Status" value="<?php if($Mainid!=""){   if($fetchLead['Status']=='4'){echo "Payment Received " ;} } ?>"  required >
                                </div>
                            </div>
                     <!-- <div class="form-group col-md-6">
                           ...
                           <div class="form-row">
                             ...
                             <div class="form-group">
                                <label for="Primary_Area">Area</label>&nbsp;<label id="label3"></label>
                                <input type="text" class="form-control" id="Primary_Area" name="Primary_Area" placeholder="Area of pincode *"  value="<?php if($Mainid!=""){echo $fetchLead['pincodeOfArea'];} ?>"  required>
                            </div>
                             ...
                             <div class="form-group col-md-6">
                                <label for="inputAddress2">State</label>
                                     <input type="text" class="form-control" id="Primary_State" name="Primary_State" placeholder="State *"  value="<?php if($Mainid!=""){echo $fetchLead['State'];} ?>" required >
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-8 col-sm-8">
                                    ...
                                    <input type="text" class="form-control" id="Primary_mob1" name="Primary_mob1" maxlength="10" onkeypress="return isNumberKey(event)" value="<?php if($Mainid!=""){echo $fetchLead['MobileNumber'];} ?>"  placeholder="Mobile number" required  >
                                </div>
                            </div>
                             ...
                             <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="inputEmail4">Mobile Code *</label>
                                    <input type="text" class="form-control"  name="Primary_mcode2" id="Primary_mcode2" maxlength="3"  onkeypress="return isNumberKey(event)"  value="+91"  placeholder="eg. 91" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Mobile number *</label>&nbsp;<label id="label5"></label>
                                    <input type="text" class="form-control" id="Primary_mob2" name="Primary_mob2" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Mobile number"  >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="Primary_Contact1code" id="Primary_Contact1code" value="<?php if($Mainid!=""){echo $fetchLead['contact1Code'];} ?>" onkeypress="return isNumberKey(event)" maxlength="3" placeholder="eg. 022" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Contact Number1</label>
                                    <input type="text" class="form-control" id="Primary_Contact1" name="Primary_Contact1" maxlength="10" value="<?php if($Mainid!=""){echo $fetchLead['ContactNo1'];} ?>" onkeypress="return isNumberKey(event)" placeholder="Contact Number 1"  >
                                </div>
                            </div>
                           ...
                           <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="inputEmail4">Code</label>
                                    <input type="text" class="form-control" name="Primary_Contact2code" id="Primary_Contact2code" value="022" onkeypress="return isNumberKey(event)" maxlength="3" placeholder="eg. 022" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Contact Number2</label>
                                    <input type="text" class="form-control" id="Primary_Contact2" name="Primary_Contact2" maxlength="10" onkeypress="return isNumberKey(event)"  placeholder="Contact Number 2"  >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="inputEmail4">Code</label>
                                    <input type="text" class="form-control" name="Primary_Contact3code" id="Primary_Contact3code" value="022" onkeypress="return isNumberKey(event)" maxlength="3" placeholder="eg. 022" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Contact Number3</label>
                                    <input type="text" class="form-control" id="Primary_Contact3" name="Primary_Contact3" onkeypress="return isNumberKey(event)" maxlength="10"  placeholder="Contact Number3"  >
                                </div>
                            </div>
                            ...
                            <div class="form-group ">
                             ...
                             <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Anniversary"  name="Primary_Anniversary" placeholder="dd-mm-yyyy" >
                                </div>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="inputEmail4">Mobile Code *</label>
                                    <input type="text" class="form-control"  name="Spouse_mcode1Married1" id="Spouse_mcode1Married1" maxlength="3" onkeypress="return isNumberKey(event)"  value="+91"  placeholder="eg. 91" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Mobile number *</label>&nbsp;<label id="label5"></label>
                                    <input type="text" class="form-control" id="Spouse_mob1MArid1" name="Spouse_mob1MArid1" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Mobile number"  >
                                </div>
                            </div>
                             ...
                             <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    <label for="inputEmail4">Mobile Code *</label>
                                    <input type="text" class="form-control"  name="Spouse_mcode1Married2" id="Spouse_mcode1Married2" maxlength="3"  onkeypress="return isNumberKey(event)" value="+91"  placeholder="eg. 91" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Mobile number *</label>&nbsp;<label id="label5"></label>
                                    <input type="text" class="form-control" id="Spouse_mob1MArid2" name="Spouse_mob1MArid2" maxlength="10"  onkeypress="return isNumberKey(event)" placeholder="Mobile number"  >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="Spouse_Contact1codeMArid" id="Spouse_Contact1codeMArid" maxlength="3" onkeypress="return isNumberKey(event)" value="022" placeholder="eg. 022" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Contact1 Number</label>
                                    <input type="text" class="form-control" id="Spouse_Contact1Married" name="Spouse_Contact1Married" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Contact1 For Married"  >
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <input type="text" class="form-control" name="Spouse_Contact2codeMArid" id="Spouse_Contact2codeMArid" value="022" maxlength="3" onkeypress="return isNumberKey(event)" placeholder="eg. 022" >
                                </div>
                                <div class="form-group col-md-8 col-sm-8">
                                    <label for="inputPassword4">Contact2 Number</label>
                                    <input type="text" class="form-control" id="Spouse_Contact2Married" name="Spouse_Contact2Married" maxlength="10" onkeypress="return isNumberKey(event)" placeholder="Contact Number" >
                                </div>
                            </div>
                        
                            <div class="form-group ">
                                    <label for="Spouse_DateOfBirth">Date Of Birth</label>
                                    <input type="text" class="form-control" id="Spouse_DateOfBirth"  name="Spouse_DateOfBirth" placeholder="dd-mm-yyyy" required >
                                </div>
                      ...
                      <br /><br />
                        ...
                        <?php 
                          ...
                          $fetchStatic_LeadID=mysqli_fetch_assoc($QryStatic_LeadID);
                        ...
                        ?>
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="MemshipDts_GST_number" name="MemshipDts_GST_number"  value="<?php echo $fetchStatic_LeadID['GST_Number']; ?>" maxlength="15" >
                                 </div>
                        ...
                        <div id="Hide_Discount_UplodeAuthorisation" style="display:none">        
                               ...
                               -->  
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="Relationships_ReferredByLEADID" id="Relationships_ReferredByLEADID"  placeholder="Referred by LEAD ID" >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Referred by MEMBERSHIP ID</label>
                                    <input type="text" class="form-control" id="Relationships_ReferredByMEMBERSHIPID" name="Relationships_ReferredByMEMBERSHIPID"  placeholder="Referred by MEMBERSHIP ID"  >
                                </div>
                            </div>
                             ...
                             <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputEmail4">Referred by LEAD ID</label>
                                    <input type="text" class="form-control" name="Issue_ReferredByLEADID" id="Issue_ReferredByLEADID"  placeholder="Referred by LEAD ID"  >
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Referred by MEMBERSHIP ID</label>
                                    <input type="text" class="form-control" id="Issue_ReferredByMEMBERSHIPID" name="Issue_ReferredByMEMBERSHIPID"  placeholder="Referred by MEMBERSHIP ID"  >
                                </div>
                            </div>
