            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form method="POST" action="Member_Payment_Process.php"  enctype="multipart/form-data" >
                        <div class="card-body">
                             ...
                             <input type="hidden" value="<?php echo $Mainid;?>" id="Mainid" name="Mainid">
                                ...
                                <div class="form-group">
                                   ...
                                   <input type="hidden" class="form-control" id="Hidden_MembershipDetails_id" name="Hidden_MembershipDetails_id" value="<?php echo $_POST['Hidden_MembershipDetails_id'] ;?>" readonly required>
                                </div>
