                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view voucher Type 
                        </h4>
                    </div>
                </div>
            </div>
...
?>
  ...
  ?>
	...
	<td><?php echo $_row['serialNumber']; ?></td>
	<td><?php echo $_row['serviceName']; ?></td>
	

	


<td><input type="button" onclick="window.open('voucher_Type.php?id=<?php echo $_row['V_type_id'];?>','_self');" value="Edit Lead">  </td>
