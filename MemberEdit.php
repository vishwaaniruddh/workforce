            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card m-b-30">
                        ...
                        <form method="POST" action="MemberEdit_Process.php"  enctype="multipart/form-data" >
                        <div class="card-body">
...
<br />
                            ...
                            <div class="form-group">
                                ...
                                <a class="btn btn-danger" href="void.php?id=<?php echo $Mainid ; ?>">Void</a>
                            </div>
                        </div>
                        </form>
                    </div>
