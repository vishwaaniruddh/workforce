                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Primary Membership Fee
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from PrimaryMembershipFee ";
...
?>
                            ...
                            <div class="table-responsive p-t-10">
                                <table id="example" class="table   " style="width:100%">
                                    ...
                                    <tr>
                                        ...
                                        <th>Program Name  </th>
                                        <th>Program Level  </th>
                                        <th>New Membership Fee</th>
                                        <th>Renewal Membership Fee</th>
                                        <th>GST%</th>
	...
	$sql3="select level_name from Level where Leval_id='".$_row['P_Level_id']."'";
  ...
  ?>
	...
	<td><?php echo $_row['NewMembership']; ?></td>
	<td><?php echo $_row['RenewalMembership']; ?></td>
	<td><?php echo $_row['GST']; ?></td>

	


<td><input type="button" onclick="window.open('PrimaryMembershipFee_Edit.php?id=<?php echo $_row['MembershipFee_id'];?>','_self');" value="Edit Lead">  </td>
