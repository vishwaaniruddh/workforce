                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Welcome Letter
                        </h4>
                    </div>
                </div>
            </div>
...
?><form method="post" action="Leadpdf/customize_WelcomeLetter_PDF.php"  target="_blank">
                        <div class="card-body">
                            
                                <div class="form-row">
                         
                                  <div class="form-group col-md-6">
                                  <input type="text" class=" form-control" id="MembershipNum" name="MembershipNum" placeholder="Membership Number">
                                  </div>
