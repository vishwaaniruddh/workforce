                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Validity 
                        </h4>
                    </div>
                </div>
            </div>
...
?>
	...
	$sql3="select level_name from Level where Leval_id='".$_row['Leval_id']."'";
  ...
  ?>
	...
	<td><?php echo $_row['Expiry_month']; ?></td>
	

	


<td><input type="button" onclick="window.open('validity.php?id=<?php echo $_row['validity_id'];?>','_self');" value="Edit Lead">  </td>
