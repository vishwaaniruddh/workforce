                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Suspended Lead
                        </h4>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from Leads_tableSuspend where Status='3' or Excel='1'";
...
<td><?php echo $srn;?></td>
	...
	<td><?php echo $_row['ExcelReason']; ?></td>
	<td><?php $ddd=$_row['Creation']; echo date('d-m-Y', strtotime($ddd));  ?></td>
	
   


<!--<td><input type="button" class="btn btn-primary" onclick="window.open('lead_entry1.php?id=<?php echo $_row['Lead_id'];?>&excelid=1','_self');" value="Edit">  </td>
-->
