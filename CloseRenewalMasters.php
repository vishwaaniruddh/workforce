            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> Close Renewal Reason  Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                 Close Renewal Reason  Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="CloseRenewalReason_process.php"  onsubmit="return validation()" >
                        <div class="card-body ">
                            <div class="form-group">
                                <label for="inputAddress">Program Name</label>&nbsp;
                                     ...
                                     <div class="form-group">
                                        <label for="inputAddress">Close Renewal Reason</label>&nbsp;<label id="label3"></label>
                                      ...
                                      <table class="form-table" id="customFields">
                                        ...
                                        <div class="form-group col-md-10">
                                      	<input type="text" class="code form-control" id="CloseRenewalReason" name="CloseRenewalReason[]" value="" placeholder="Close Renewal Reason" required/> &nbsp;
                                        </div>
...
<script>
	...
	$(".addCF").click(function(){
		$("#customFields").append('<tr valign="top"><td style="display:flex;    width: 179%;"><input type="text" class="code form-control" id="CloseRenewalReason" name="CloseRenewalReason[]" value="" placeholder="Close Renewal Reason" style="width:100%" required/>  &nbsp;<button type="button" class="btn m-b-15 ml-2 mr-2  btn-rounded-circle btn-info remCF"><i class="mdi mdi-minus"></i></button> </td></tr>');
	});
