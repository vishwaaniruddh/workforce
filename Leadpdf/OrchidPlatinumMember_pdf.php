...
$pdf->Ln(100);
$pdf->image('PLATINUM.png',80,90,50,40);


$pdf->Cell(100, 10, 'Dear:'.$Primary_nameOnTheCard, 0, 'L', 1, 0, '', '', true);
$pdf->Ln(10);

$pdf->MultiCell(170, 10, 'Welcome to Orchid Platinum and to a host of benefits and privileges that are now yours to enjoy on dining and accommodation at The Orchid Hotel Pune, The Orchid Hotel Mumbai Vile Parle, Fort JadhavGADH Pune, Mahodadhi Palace Puri, Lotus Eco Resort Konark and Lotus Beach Resort Goa with more hotels being added soon.', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(20);
...
$pdf->MultiCell(170, 10, 'The annual membership charge of Rs. 15,000 + 18% Goods & Services Tax amounting to Rs. 17,700/- (RupeesSeventeen Thousand Seven Hundred only) has been received by '.$fetchgen['MembershipDts_PaymentMode'].'. ', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(10);
...
$pdf->Cell(170, 10, 'Gift Certificates issued – Orchid Platinum', 0, 'L', 1, 0, '', '', true);
$pdf->Ln(10);
...
$pdf->image('orchid1.png',20,220,20,30);
$pdf->image('jadhav1.png',60,220,20,30);
$pdf->image('mahodadhi1.png',110,220,20,30);
$pdf->image('lotus1.png',160,220,20,30);

$pdf->Ln(38);
////////////////////////////////////////////////////////////

$pdf->MultiCell(170, 10, 'The membership program is operated by Loyaltician CRM India Private Limited for Kamat Hotels India Limited.', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(20);

$pdf->MultiCell(160,10, 'The membership program is operated by Loyaltician CRM India Private Limited for Kamat Hotels India Limited. 
This message is sent to you because your email address is on our subscribers list as a Member with an express consent to communicate with you. We will ensure only high quality / relevant information is sent to you to manage your membership. If you wish to change any communication preferences, please write to us at escalations@loyaltician.com
', 0, 'L', 0, 1, '', '', true);
$pdf->Ln(10);
...
$pdf->MultiCell(160, 5, 'Disclaimer: This message has been sent as a part of discussion between (orchidgoldpune@orchidhotel.com) and the addressee whose name is specified above. Should you receive this message by mistake, we would be most grateful if you informed us that the message has been sent to you. In this case, we also ask that you delete this message from your mailbox, and do not forward it or any part of it to anyone else. Thank you for your cooperation and understanding.', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(10);
...
$body .= "Welcome Orchid Platinium.".$eol;
