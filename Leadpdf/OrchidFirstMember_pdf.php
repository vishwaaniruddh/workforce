...
$pdf->Ln(100);
$pdf->image('FIRST.png',80,90,50,40);


$pdf->Cell(170, 10, 'Dear:'.$Primary_nameOnTheCard.' , ', 0, 'L', 1, 0, '', '', true);
$pdf->Ln(10);

$pdf->MultiCell(170, 10, 'Welcome to Orchid First and to a host of benefits and privileges that are now yours to enjoy on dining and accommodation at The Orchid Hotel Pune, The Orchid Hotel Mumbai Vile Parle, Fort JadhavGADH Pune, Mahodadhi Palace Puri, Lotus Eco Resort Konark and Lotus Beach Resort Goa with more hotels being added soon.', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(20);
...
$pdf->MultiCell(170, 10, 'The annual membership charge of Rs.7,500 + 18% Goods & Services Tax amounting to Rs. 8,850/- (RupeesEight Thousand Eight Hundred and Fifty only) has been received by '.$fetchgen['MembershipDts_PaymentMode'].'. ', 0, 'L', 0, 0, '', '', true);
$pdf->Ln(10);
...
$pdf->Cell(170, 10, 'Team Orchid First', 0, 'L', 1, 0, '', '', true);
$pdf->Ln(10);
...
$pdf->Cell(170, 10, 'Gift Certificates issued – Orchid First', 0, 'L', 1, 0, '', '', true);
$pdf->Ln(10);
...
$pdf->image('orchid1.png',20,180,20,30);
$pdf->image('jadhav1.png',60,180,20,30);
$pdf->image('mahodadhi1.png',110,180,20,30);
$pdf->image('lotus1.png',160,180,20,30);
