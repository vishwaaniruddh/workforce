                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Brand
                        </h4>
                    </div>
                </div>
            </div>
...
?>
  ...
  ?>
                             <tr>
    <td><?php echo $srn;?></td>
	<td><?php echo $_row['Brand_name']; ?></td>
	
	


<td><input type="button" onclick="window.open('brand.php?id=<?php echo $_row['Brand_id'];?>','_self');" value="Edit Lead">  </td>
