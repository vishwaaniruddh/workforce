...
<?php 
  if($_SESSION['register_id']=='1'){
      $View="select a.LeadId,a.SalesmanId,b.Lead_id,b.FirstName,b.LastName,b.MobileNumber,b.EmailId,b.Country,b.State,b.City,b.LeadSource,b.Status,b.Nationality,b.Title,b.Company,b.LeadSource from LeadDelegation a,Leads_table b where a.LeadId=b.Lead_id and b.Status!='2' ORDER BY `a`.`LeadId` desc";

 }else{
 $View="select a.LeadId,a.SalesmanId,b.Lead_id,b.FirstName,b.LastName,b.MobileNumber,b.EmailId,b.Country,b.State,b.City,b.LeadSource,b.Status,b.Nationality,b.Title,b.Company,b.LeadSource,b.PinCode from LeadDelegation a,Leads_table b where a.LeadId=b.Lead_id and a.SalesmanId='".$_SESSION['register_id']."' and b.Status='5' ORDER BY `a`.`LeadId` desc ";
 }
//echo $View;
                             ...
                             <div class="table-responsive p-t-10">
                                <table id="example" class="table" style="width:100%">
                                    ...
                                    <tr>
                                        				...
                                        				<th>LastName</th>
                                        				<th>Lead Source</th>
                                        				 <?php if($_SESSION['roll_id']!="15"){?>	<th>MobileNumber</th>
                                        				<th>EmailId</th>
                                        				<th>Country</th>
                                        				<th>State</th>
                                        				<th>City</th>
