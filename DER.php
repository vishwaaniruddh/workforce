                      ...
                      //  alert(msg);
                        $('#setTable').empty();
                          ...
                          //  alert(json[i].FirstName)
                            ...
                            $('#setTable').append('<tr role="row" class="odd" ><td class="sorting_1">'+srno+'</td><td>'+json[i].Primary_nameOnTheCard+'</td><td>'+json[i].GenerateMember_Id+'</td><td>'+json[i].level_name+'</td><td>'+json[i].R+'</td> </tr>');
                          }
