                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Hotel
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from Hotel_Creation ";
...
?>
		...
		$srn=1;
			...
			{
	$sql2="select Brand_name from Brand where Brand_id='".$_row['Brand']."'";
  ...
  ?>
                             <tr>
    <td><?php echo $srn;?></td>
	<td><?php echo $_row['Hotel_Name']; ?></td>
	<td><?php echo $sql2fetch['Brand_name']; ?></td>
	<td><img src="<?php echo 'http://sarmicrosystems.in/Lead_Management/Loyaltician/'.$_row['logo']; ?>" height="100px" width="100px"/></td>
	
	


<td><input type="button" onclick="window.open('Card_Benefits.php?id=<?php echo $_row['Brand_id'];?>','_self');" value="Edit Lead">  </td>
