            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> Membership Payment Mode Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                Membership Payment Mode Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="MembershipPaymentMode_Process.php"  onsubmit="return validation()" >
                        <div class="card-body ">
                            <div class="form-group">
                                ...
                                <label for="inputAddress">Payment Mode</label>&nbsp;
                                    <!--    <select class="form-control"  name="Payment_mode" id="Payment_mode"  required>
                                        ...
                                        <option value="Rupay">Online</option>
