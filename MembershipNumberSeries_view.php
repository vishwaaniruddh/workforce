                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Member shipNumber Series
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from MembershipNumberSeries ";
...
?>
  ...
  ?>
	...
	<td><?php echo $_row['FromSeries']; ?></td>
	<td><?php echo $_row['ToSeries']; ?></td>
	

	


<td><input type="button" onclick="window.open('Program_view.php?id=<?php echo $_row['Hotel_id'];?>','_self');" value="Edit Lead">  </td>
