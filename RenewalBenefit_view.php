...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from RenewalBenefits ";
...
<td><?php echo $srn;?></td>
	...
	<td><?php echo $_row['RenewalBenefits']; ?></td>
	


<td><input type="button" onclick="window.open('RenewalBenefit.php?id=<?php echo $_row['RenewalBenefits_id'];?>','_self');" value="Edit Lead">  </td>
