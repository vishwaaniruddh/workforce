                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> View Assigned Leads
                        </h4>
...
?>
  ...
  $leadCount=mysqli_num_rows($leadUpdt);
	if($leadCount>0){
	?><input type="button" id="qtnview<?php echo $srn;?>" class="btn btn-primary"  onclick="window.open('updatecomment.php?ids=<?php echo $_row['Lead_id'];?>', '_blank', 'location=yes,height=400,width=600,left=400,top=200,scrollbars=yes,status=yes');" value="View"><?php } ?> </td>
	<td><?php if($_row['Status']!='4'){?><input type="button" class="btn btn-primary"  id="qtnview<?php echo $srn;?>" onclick="window.open('leadupdate.php?id=<?php echo $_row['LeadId'];?>','_self');" value="Lead Update"><?php } ?> </td>

		<td><?php if($_row['Status']!='4'){?><input type="button" class="btn btn-primary"  id="qtnview<?php echo $srn;?>" onclick="window.open('member_Payment.php?id=<?php echo $_row['LeadId'];?>','_self');" value="Payment"> <?php } ?></td>
