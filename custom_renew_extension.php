                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                ...
                                <a class="btn btn-danger" href="MemberEdit.php?id=<?php echo $id; ?>">View Member Info</a>
...
while($voucher_sql_result = mysqli_fetch_assoc($voucher_sql)){
    ...
    // echo '</del>';        
          ...
          <input type="checkbox" name="vouchers[]" value="<?php echo $voucher;?>">
<?php        echo get_voucher_name($level_id,$voucher_name_id);
    echo '<br>';
    }
...
?>
   ...
   //     $get_sql = mysqli_query($conn,"select * from Members where Static_LeadID='".$id."'");
    ...
    //    $get_sql_result = mysqli_fetch_assoc($get_sql);
        ...
        <h5>Expiry Date  : <span style="color:red;"><?php echo $expiry; ?></span></h5>
        <hr>                 
                                 
        <h6 style="margin: 3% auto;">Please Select The Renewal Months </h6>
        
        <p> Select Months > From date > Extend  </p>
        ...
        <select class="form-control" name="extension">
            ...
            <input type="text" data-date-format='yyyy-mm-dd' name="payment_date" id="datepicker" class="form-control" placeholder="Select Date">
            </div>
                        ...
                        ?>
                            ...
                            <div class="form-group">
                                 ...
                                 <div class="custom-control custom-checkbox">
                                    <input type="checkbox" class="custom-control-input" id="renewalPromotionalCheck1" name="renewalPromotionalCheck1">
                                    <label class="custom-control-label" for="renewalPromotionalCheck1">Issue Renewal Promotional Certificate</label> 
                                </div>
                                 <br>
                                 <br><br>
                                 
                                 <input type="submit" name="submit" class="btn btn-success" value="Renew" disabled>
