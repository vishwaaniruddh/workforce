...
<body>
    ...
    if(isset($_POST['Primary_Country']) && $_POST['Primary_Country']!=''){
        $Primary_Country = $_POST['Primary_Country'];
    }
...
$AssignBooklet = $new_booklet_to_assigned; 
...
<td>
<img style="width:100%;" id="Picture 4" src="https://sarsspl.com/Lead_Management/Loyaltician/clubfourpoints/newassets/image001.jpg">
...
<p>
      ...
      <img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/clubfourpoints/newassets/image002.png" alt="The Orchid Gold"></span>
    <u></u><u></u></p>
</td>
<td width="325" style="width:243.75pt;padding:11.25pt 0cm 0cm 0cm">
<p align="right" style="text-align:right">

  <span style="text-decoration:none"><img border="0" width="130" style="width:1.3541in" src="https://sarsspl.com/Lead_Management/Loyaltician/clubfourpoints/newassets/image003.png" alt="The Orchid Platinum">
  </span>
