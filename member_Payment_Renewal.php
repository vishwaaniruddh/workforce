            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> Renewal Payment Details
                        </h4>
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                Renewal Payment Entry
                            </h5>
                        </div>
                        
                        
                       <form method="POST" action="Renewal_invoice.php"  enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                             ...
                             <input type="hidden" value="<?php echo $Mainid;?>" id="Mainid" name="Mainid">
                              <input type="hidden"  id="Hidden_MembershipDetails_id" name="Hidden_MembershipDetails_id">
                               ...
                               <?php $R_Level=mysqli_query($conn,"select MembershipDetails_Level from Members where Static_LeadID='".$_GET['id']."' ");
                               $R_L_Fetch=mysqli_fetch_array($R_Level);
                                  ...
                                  <select class="form-control"  name="MembershipDetails_Level" id="MembershipDetails_Level"    onchange="setDropDown('MembershipDetails_Level','PrimaryMembershipFee','P_Level_id','MembershipFee_id','NewMembership','MembershipDetails_Fee')" required>
                                        ...
                                        <?php
                                         $levelQry="select * from Level where 1=1";
                                          ...
                                          <option value="<?php echo $fetchLevel['Leval_id'];?>" <?php if($fetchLevel['Leval_id']==$R_L_Fetch[0]){ ?>selected<?php }?> ><?php echo $fetchLevel['level_name'];?></option>
                                          <?php } ?>
                                  </select>
                                </div>
...
<?php
if($R_L_Fetch[0]!=""){?>
                                 <script>  setDropDown('MembershipDetails_Level','PrimaryMembershipFee','P_Level_id','MembershipFee_id','NewMembership','MembershipDetails_Fee');</script>
                            <?php   }