                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Voucher Booklet 
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from voucher_Booklet ";
...
?>
  ...
  ?>
	...
	<td><?php echo $_row['FromSerialNo']; ?></td>
	<td><?php echo $_row['ToSerialNo']; ?></td>
	

	


<td><input type="button" onclick="window.open('voucher_booklet.php?id=<?php echo $_row['v_id'];?>','_self');" value="Edit Lead">  </td>
