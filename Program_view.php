                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Program
                        </h4>
                    </div>
                </div>
            </div>
...
?>
		...
		$srn=1;
			...
			{
	$sql2="select Hotel_Name from Hotel_Creation where hotel_id='".$_row['Hotel_id']."'";
  ...
  ?>
                             <tr>
    <td><?php echo $srn;?></td>
	<td><?php echo $sql2fetch['Hotel_Name']; ?></td>
	<td><?php echo $_row['Progam_name']; ?></td>

	


<td><input type="button" onclick="window.open('Program.php?id=<?php echo $_row['Program_ID'];?>','_self');" value="Edit Lead">  </td>
