...
function searchfiltter(){
    ...
    if(FromDt==""){
          ...
          swal("Please Select To Date");
             ...
             $.ajax({
                    type:'POST',
                    url:'MonthWiseSearch_Filtter.php',
                     ...
                     //  alert(msg);
                        $('#setTable').empty();
                          ...
                          //  alert(json[i].FirstName)
                            ...
                            $('#setTable').append('<tr role="row" class="odd" ><td class="sorting_1">'+srno+'</td><td>'+json[i].GenerateMember_Id+'</td><td>'+json[i].FirstName+'</td><td>'+json[i].LastName+'</td><td>'+json[i].MembershipDetails_Level+'</td><td>'+json[i].Expirydate+'</td> <td>'+json[i].MobileNumber+'</td><td>'+json[i].Primary_DateOfBirth+'</td><td>'+json[i].Primary_Anniversary+'</td></tr>');
                          }
                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> PETALS REPORT 
                        </h4>
                    </div>
                </div>
            </div>
...
$R=$formattedValue;
  ...
  ?>
	...
	<td><?php echo $R; ?></td>
            ...
            <div class="cols-md-8">
        <form name="frm" method="post" action="export_monthwise_report.php" target="_new">
