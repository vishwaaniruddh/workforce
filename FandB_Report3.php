...
function myFunction() {
  window.print();
   ...
   <br />
                            <div class="row">
                                <div class="col-md-6" style="position: relative;padding-left: 15px;border-right-width: 73px;padding-right: 58px;"><h3 align="center" id="hd_text1" style="display:none">Visits / Covers by Month</h3><div id="chart"></div></div>
                                <div class="col-md-6" ><h3 align="center" id="hd_text2" style="display:none">Covers by Meal Period by Month</h3><div id="chart02"></div></div>
                            </div>
    <br />
    <hr />
     <hr />
    ...
    <script src="assets/vendor/apexchart/apexcharts.min.js"></script>
     ...
     <script>            
         ...
         function graph1(FromDt,Todt){
                   ...
                   $.ajax({
                    type:'POST',
                    url:'getFandB3_GraphProcess.php',
                      ...
                      var MonthName=[];
                       var Visits=[];
                        ...
                        for(var i=0;i<jsr.length;i++){
                            ...
                            Visits.push(parseInt(jsr[i]["Visits"]));
                   ...
                   $.ajax({
                    ...
                    success:function(msg){
                       ...
                       var Dinner=[];
                         ...
                         for(var i=0;i<jsr.length;i++){
                            MonthName.push(jsr[i]["MonthName"]);
                            Breakfast.push(parseInt(jsr[i]["Breakfast"]));
                            Lunch.push(parseInt(jsr[i]["Lunch"]));
                            Dinner.push(parseInt(jsr[i]["Dinner"]));
                         }
                    ...
                    success:function(msg){
                      //alert(msg);
                       ...
                       var Dinner=[];
                         ...
                         var jsr=JSON.parse(msg);
                         for(var i=0;i<jsr.length;i++){
                            MonthName.push(jsr[i]["Monday"]);MonthName.push(jsr[i]["Tuesday"]);MonthName.push(jsr[i]["Wednesday"]);MonthName.push(jsr[i]["Thursday"]);MonthName.push(jsr[i]["Friday"]);MonthName.push(jsr[i]["Saturday"]);MonthName.push(jsr[i]["Sunday"]);
                            Breakfast.push(parseInt(jsr[i]["MonBreakfast"]));Breakfast.push(parseInt(jsr[i]["TueBreakfast"]));Breakfast.push(parseInt(jsr[i]["WedBreakfast"]));Breakfast.push(parseInt(jsr[i]["ThurBreakfast"]));Breakfast.push(parseInt(jsr[i]["FriBreakfast"]));Breakfast.push(parseInt(jsr[i]["SatBreakfast"]));Breakfast.push(parseInt(jsr[i]["SunBreakfast"]));
                            Lunch.push(parseInt(jsr[i]["MonLunch"]));Lunch.push(parseInt(jsr[i]["TueLunch"]));Lunch.push(parseInt(jsr[i]["WedLunch"]));Lunch.push(parseInt(jsr[i]["ThurLunch"]));Lunch.push(parseInt(jsr[i]["FriLunch"]));Lunch.push(parseInt(jsr[i]["SatLunch"]));Lunch.push(parseInt(jsr[i]["SunLunch"]));
                            Dinner.push(parseInt(jsr[i]["MonDinner"]));Dinner.push(parseInt(jsr[i]["TueDinner"]));Dinner.push(parseInt(jsr[i]["WedDinner"]));Dinner.push(parseInt(jsr[i]["ThurDinner"]));Dinner.push(parseInt(jsr[i]["FriDinner"]));Dinner.push(parseInt(jsr[i]["SatDinner"]));Dinner.push(parseInt(jsr[i]["SunDinner"]));
                         }
                    ...
                    success:function(msg){
                      // alert(msg);
                       ...
                       var netRevenue=[];
                        ...
                        for(var i=0;i<jsr.length;i++){
                            MonthName.push(jsr[i]["MonthName"]);
                            netRevenue.push(parseInt(jsr[i]["netRevenue1"]));
...
function Box(Page,perp,fromDt,ToDt){
     $.ajax({
            type:'POST',    
            url:'FandB_Report3_searchBox.php',
            data:'Page='+Page+'&perpg='+perp+'&FromDt='+fromDt+'&ToDt='+ToDt,
            success: function(msg){
