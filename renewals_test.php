                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Renewals Available
                        </h4>
                    </div>
                </div>
            </div>
...
<tr <?php if($_row['ExpiryDate']>date('Y-m-d')){ echo 'class="about_to_expire"'; } else{ echo 'class="expire"';}?>>
        ...
        <?php if($_SESSION['roll_id']=='1'){ ?>
                ...
                <td><a class="btn btn-primary" href="renewal_delegation.php?id=<?php echo $_row['Static_LeadID']; ?>">Delegate</a></td>
        <?php } ?>
        
        
        <td><a class="btn btn-danger" href="custom_renew_test.php?id=<?php echo $_row['Static_LeadID'];?>">Renew</a></td>
        <td><a class="btn btn-success" href="Renewals_leadupdate.php?id=<?php echo $_row['Static_LeadID'];?>">Update</a></td>
        

        
        <td><a class="btn btn-dark" href="reject_renewal.php?id=<?php echo $_row['Static_LeadID'];?>">Close</a></td>
