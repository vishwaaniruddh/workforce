                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Services 
                        </h4>
                    </div>
                </div>
            </div>
...
?>
  ...
  ?>
	...
	<td><?php echo $_row['POScode']; ?></td>

	


<td><input type="button" onclick="window.open('services.php?id=<?php echo $_row['Service_id'];?>','_self');" value="Edit Lead">  </td>
