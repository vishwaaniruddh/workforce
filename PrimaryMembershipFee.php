            ...
            <div class="container  m-b-30">
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class="">  Primary Membership Fee Creation
                        </h4>
                       <!-- <p class="opacity-75 ">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                        <div class="card-header">
                            <h5 class="m-b-0">
                                 Primary Membership Fee Entry
                            </h5>
                            <!--<p class="m-b-0 text-muted">
                                Standard form controls
                            </p>-->
                        </div>
                        <form method="post" action="PrimaryMembershipFee_process.php"  onsubmit="return validation()" >
                        <div class="card-body ">
                            <div class="form-group">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="NewMembership" name="NewMembership" value="0" placeholder="New Membership Fee*" required>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">Renewal Membership Fee</label>
                                    <input type="text" class="form-control" id="RenewalMembership" name="RenewalMembership" value="0" placeholder="Renewal Membership Fee*" required>
                                </div>
                                </div>
