                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> Revalidation Without Renewals
                        </h4>
                    </div>
                </div>
            </div>
...
<tr <?php if($_row['ExpiryDate']>date('Y-m-d')){ echo 'class="about_to_expire"'; } else{ echo 'class="expire"';}?>>
        ...
        <td><a class="btn btn-danger" href="only_revalidation_form.php?id=<?php echo $_row['Static_LeadID'];?>">Revalidate</a></td>
