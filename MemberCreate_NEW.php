                ...
                <div class="col-lg-6">
                    ...
                    <div class="card m-b-30">
                       ...
                       <div class="form-row">
                               ...
                               <select class="form-control"  name="Primary_Country" id="Primary_Country" required  >
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Pincode" onblur="getStateCity();" name="Primary_Pincode" value="<?php if($Mainid!=""){echo $fetchLead['PinCode'];} ?>"  placeholder="Pincode *" required >
                                </div>
                            </div>
                             ...
                             <div class="form-group col-md-6">
                                 <label for="inputPassword4">State</label>
                                  <input type="text" class="form-control" id="Primary_State" name="Primary_State" placeholder="State *"  value="<?php if($Mainid!=""){echo $fetchLead['State'];} ?>" readonly required >
                       ...
                       <div class="form-row">
                               ...
                               <select class="form-control" name="Static_AssignedTo" id="Static_AssignedTo">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <select class="form-control" name="Static_LeadSource" id="Static_LeadSource" ">
                                   ...
                                   while($Sourcesfetch=mysqli_fetch_array($qerySources)){
                                    ?>
                                    <option value="<?php echo $Sourcesfetch['SourceId'];?>" id="<?php echo $Sourcesfetch['SourceId'];?>" ><?php echo $Sourcesfetch['Name'];?></option>
                                    <?php } ?>
                           ...
                           <div class="form-row">
                            ...
                            <div class="form-group ">
                             ...
                             <div class="form-group ">
                                    ...
                                    <input type="text" class="form-control" id="Primary_Anniversary"  name="Primary_Anniversary" placeholder="dd-mm-yyyy" required >
                                </div>
