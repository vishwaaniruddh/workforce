                ...
                <div class="row">
                    <div class="col-12 text-white p-t-40 p-b-90">
                        ...
                        <h4 class=""> <span class="btn btn-white-translucent">
                                <i class="mdi mdi-table "></i></span> view Membership Type
                        </h4>
                    </div>
                </div>
            </div>
...
<?php include("config.php");
  //  $View="select * from Leads_table where leadEntryef='".$_SESSION['id']."'";
 	  $View="select * from MembershipType ";
...
?>
		...
		$srn=1;
			...
			{
	$sql2="select Progam_name from Program where Program_ID='".$_row['Progm_id']."'";
  ...
  ?>
	...
	<td><?php echo $_row['MembershipType']; ?></td>
