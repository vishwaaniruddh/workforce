...
$fontStyle = array('bold' => true, 'align' => 'right');
...
$table = $section->addTable(array('width' => 50*70, 'unit' => 'pct', 'align' => 'center','borderSize' => 6, 'borderColor' => '999999'));
$table->addRow();
$table->addCell($styleCell)->addText(htmlspecialchars('Invoice 1'), $fontStyle);
$table->addCell($styleCell)->addText(htmlspecialchars('Date 29-01-2015'), $fontStyle);
